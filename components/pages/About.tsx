...
const values = [
  {
    ...
    description:
      "Every decision we make is guided by what's best for our students' academic and career goals.",
  },
  {
    icon: CheckCircle,
    title: "Transparency",
    description:
      "We believe in honest, clear communication about opportunities, costs, and expectations.",
  },
  {
    icon: GraduationCap,
    title: "Excellence",
    description:
      "We strive for the highest standards in counseling, training, and student support.",
  },
  {
    icon: Globe,
    title: "Global Perspective",
    description:
      "Our international network ensures students get the best opportunities worldwide.",
  },
];
        ...
        <div className="max-w-6xl mx-auto px-2 sm:px-6 relative">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Brainstorm Global Education is Nepal&apos;s trusted partner for
              international education. We&apos;ve helped thousands of students
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  To provide comprehensive, honest, and professional guidance to
                  students aspiring to study abroad, ensuring they make informed
                  decisions and successfully achieve their educational and
                  career goals.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  To be Nepal&apos;s most trusted and respected education
                  consultancy, known for our integrity, expertise, and
                  unwavering commitment to student success in the global
                  academic arena.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Founded in 2015, Brainstorm Global Education started with a
                  simple mission: to help Nepali students access quality
                  education abroad without the confusion and stress that often
                  comes with the process.
                </p>
                <p>
                  What began as a small office in Kathmandu has grown into one
                  of Nepal&apos;s leading education consultancies, with
                  partnerships spanning over 100 universities across USA, UK,
                  Australia, Canada, and New Zealand.
                </p>
                <p>
                  Today, we&apos;re proud to have helped more than 5,000
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our team of experienced counselors and trainers are dedicated to
              helping you succeed.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {isLoading
              ...
              : (teamMembers || []).map((member) => (
                  <div
                    key={member.id}
                    className="bg-card  border-border overflow-hidden group rounded-lg cursor-pointer"
                  >
                    <div className="aspect-square p-8">
                      {member.photo ? (
                        <Image
