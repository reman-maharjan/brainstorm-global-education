      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {videos.map((video) => (
            <Card
              key={video.id}
              className="group relative aspect-9/16  overflow-hidden cursor-pointer transition-all duration-300 hover:shadow-md hover:-translate-y-1 p-0 rounded-xl"
            >
        ...
        <div className="flex justify-center gap-4 mt-8">
          <a
            href="#"
            className="flex items-center gap-2 bg-card  border-border px-6 py-3 font-medium transition-all hover:shadow-sm hover:-translate-y-0.5"
          >
