...
const features = [
  ...
  },
  {
    ...
    description: "Excellent track record with top universities worldwide.",
  },
  {
    icon: HeartHandshake,
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <Badge
              variant="outline"
              className="text-sm font-semibold text-primary tracking-wider uppercase mb-3 border-primary/20"
            >
              Why Choose Us
            </Badge>
            ...
            <p className="text-muted-foreground">
              For over 15 years, Brainstorm Global Education has been
              transforming dreams into reality. We combine expertise with
