...
const LogoStrip = () => (
  <div className="flex flex-wrap justify-between items-center gap-8 mt-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
    <span className="text-xl font-bold flex items-center gap-2"><div className="w-6 h-6 bg-[#013D2F] rounded-full"></div> Segment</span>
    <span className="text-xl font-bold flex items-center gap-1">splunk<span className="text-accent">&gt;</span></span>
    ...
    <div className="p-18">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
        ...
        <div className="relative">
          ...
          {/* Badge */}
          <div className="absolute top-8 right-8 bg-#84cc16 text-white p-6 rounded-2xl w-32 h-32 flex flex-col items-center justify-center text-center shadow-lg transform rotate-3 hover:rotate-0 transition-transform cursor-default">
          ...
          <div className="absolute -bottom-10 -left-6 hidden md:flex items-center justify-center bg-[#FDFDFD] rounded-full p-2 w-32 h-32 animate-[spin_10s_linear_infinite]">
            <div className="w-full h-full border border-dashed border-gray-300 rounded-full flex items-center justify-center relative">
               <MoveUpRight className="text-[#013D2F]" />
               <svg className="absolute w-full h-full p-1" viewBox="0 0 100 100">
                 <path id="curve" d="M 50 50 m -37 0 a 37 37 0 1 1 74 0 a 37 37 0 1 1 -74 0" fill="transparent"/>
                 <text className="text-[10px] uppercase font-bold tracking-widest fill-[#013D2F]">
                   <textPath href="#curve">
        ...
        <div className="space-y-8">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-[#013D2F] leading-tight">
            Where Wanderlust Meets <br/>
            <span className="text-[#013D2F]">Dream Destinations</span>
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-[#F4F6F5] p-6 rounded-2xl hover:bg-white hover:shadow-md transition-all">
              <div className="flex items-center gap-3 mb-4">
                 ...
                 <h4 className="font-bold text-[#013D2F]">Passport Plus</h4>
              </div>
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-xs text-gray-600">
                    <Check size={14} className="text-accent" /> Beyond Border Immigration
                </li>
                <li className="flex items-center gap-2 text-xs text-gray-600">
                    <Check size={14} className="text-accent" /> Worldwide Visa Assistance
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#F4F6F5] p-6 rounded-2xl hover:bg-white hover:shadow-md transition-all">
              <div className="flex items-center gap-3 mb-4">
                 ...
                 <h4 className="font-bold text-[#013D2F]">Global Entry</h4>
              </div>
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-xs text-gray-600">
                    <Check size={14} className="text-accent" /> GlobeTrot Visa Services
                </li>
                <li className="flex items-center gap-2 text-xs text-gray-600">
                    <Check size={14} className="text-accent" /> Infinity Visa Solutions
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6 pt-4">
            <button className="flex items-center gap-2 px-8 py-3 rounded-full border border-gray-300 text-[#013D2F] font-bold hover:bg-[#013D2F] hover:text-white transition-colors">
                Read More <ArrowRight size={16} />
            </button>
            <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
                <div className="w-10 h-10 bg-accent rounded-full flex items-center justify-center text-white shadow-lg shadow-#84cc16/30 animate-pulse">
                    <Phone size={20} />
                </div>
                <div>
                  <div className="text-[10px] text-gray-500 uppercase font-bold">Need help?</div>
                  <div className="text-sm font-bold text-[#013D2F]">(808) 555-0111</div>
                </div>
            </div>
          </div>
        </div>
