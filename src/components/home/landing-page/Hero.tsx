...
const Hero: React.FC = () => {
  return (
    <div className="relative bg-secondary overflow-hidden min-h-[500px] sm:min-h-[600px] lg:min-h-[720px] flex items-center">
      ...
      <div className="w-full h-full relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center px-4 sm:px-8 md:px-16 py-12 sm:py-16">
        
        {/* Left Content */}
        <div className="space-y-10 max-w-2xl relative z-10">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[80px] font-bold text-white leading-[1.1] tracking-tight">
            Visa Made Easy <br />
            Dreams Made <br />
            Possible
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 lg:gap-8">
            ...
            <button className="flex items-center gap-3 sm:gap-4 group cursor-pointer">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-secondary/80 rounded-full flex items-center justify-center group-hover:bg-primary transition-colors duration-300 shadow-lg border border-white/10">
                <Play size={18} className="text-white fill-white ml-1 sm:w-5 sm:h-5" />
              </div>
              <span className="text-white font-medium text-sm sm:text-base lg:text-lg">Watch Our Videos</span>
            </button>
          </div>
        </div>
