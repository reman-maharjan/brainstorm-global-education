          ...
          <div className="flex flex-col justify-between gap-6 sm:gap-8 lg:col-span-7">
            ...
            <div className="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center">
                ...
                {/* Heading */}
                <h2 className="mb-3 text-xl font-bold leading-tight text-secondary sm:mb-4 sm:text-2xl md:text-3xl lg:text-4xl">
                ...
                {/* Button */}
                <div>
                  <Button variant="default">Contact us <Globe size={16} /></Button>
                </div>
              </div>
              ...
              <CardContent className="px-4 py-6 sm:px-6 sm:py-8 md:px-8 md:py-10">
                <div className="grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-4 md:gap-8">
                  <div className="text-center">
                    <div className="mb-1 text-2xl font-extrabold leading-none sm:text-3xl md:text-4xl lg:text-5xl">
                      10k+
                    </div>
                    <div className="text-[10px] font-medium opacity-90 sm:text-xs md:text-sm">
                      Complete project
                    </div>
                  </div>
                  <Separator
                    orientation="vertical"
                    className="hidden md:block h-12 bg-white/20 self-center"
                  />
                  <div className="text-center">
                    <div className="mb-1 text-2xl font-extrabold leading-none sm:text-3xl md:text-4xl lg:text-5xl">
                      20+
