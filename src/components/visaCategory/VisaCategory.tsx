...
const VisaCategory: React.FC = () => {
  return (
    <div className="px-4 py-12 sm:px-6 sm:py-16 lg:px-12 lg:py-18 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {categories.map((cat, idx) => (
                <div key={idx} className="bg-[#F4F6F5] p-6 md:p-8 rounded-2xl sm:rounded-3xl flex flex-col md:flex-row items-start md:items-center gap-4 sm:gap-6 group hover:bg-white hover:shadow-xl transition-all duration-300 border border-transparent hover:border-gray-100">
                    ...
                    <div className="text-left flex-1">
                        <h3 className="text-lg sm:text-xl font-bold text-secondary mb-2">{cat.title}</h3>
                        ...
                        <div className="flex justify-between items-center">
                             ...
                             <cat.icon size={28} className="text-secondary opacity-20 group-hover:opacity-100 transition-opacity sm:w-8 sm:h-8" />
                        </div>
                    </div>
                </div>
            ))}
